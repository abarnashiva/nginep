...
export default function Hero() {
    ...
    return (
        <div className="bg-gray-400 p-6 lg:p-10 rounded-lg grid lg:grid-cols-2 justify-between items-center text-gray-800 lg:mt-10 mt-6">
            <div className="text-left mb-6 md:mb-0">
                ...
                <button className="bg-amber-400 hover:bg-amber-500 text-white text-sm md:text-base font-semibold px-4 py-2 rounded-full flex items-center gap-2 transition">
                    Reserve Now
                    <span className="px-2"><button className="ml-auto bg-white p-2 rounded-full">
